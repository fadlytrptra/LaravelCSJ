        ...
        <table style="width: 100%;">
            ...
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left; border:none !important; border-right: 1px solid black !important"
                        id="nomerP">
                        001BCA10811</td>
                </tr>
                <tr>
                    ...
                    <td style="text-align: right; border:none !important; border-bottom: 1px solid black !important">
                        TANGGAL : &nbsp;</td>
                    <td style="text-align: left; border:none !important; border-right: 1px solid black !important; border-bottom: 1px solid black !important"
                        id="tanggal_atasP">
                        1/August/2011</td>
                </tr>
            </tbody>
    ...
    <div class="content">
        <table style="width: 100%;">
            ...
            <tr>
                ...
                <td style="border:none !important" colspan="2" id="terbilangP">EMPAT PULUH RIBU DUA RATUS SEMBILAN
                    PULUH DUA RPH ENAM
                    PULUH ENAM SEN</td>
            </tr>
        </table>
        ...
        <table>
            <thead>
                <tr>
                    <th colspan="3"
                        style="width: 60%;text-align: center; border:none !important; border-right: 1px solid black !important">
                        RINCIAN PENERIMAAN</th>
                    <th style="text-align: center; border:none !important; border-right: 1px solid black !important">
                        KODE PERKIRAAN</th>
                    <th style="width: 23%;text-align: center; border:none !important; border-left: 1px solid black !important"
                        colspan="2">JUMLAH
                    </th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr>
                    <td colspan="4" style="text-align: right; border:none !important"><strong>GRAND TOTAL :</strong>
                    </td>
                    <td style="width: 5%; border:none !important" id="rp_totalP"><strong>Rp.</strong></td>
                    <td style="text-align: right !important; border:none !important" id="grandP">
                        <strong>40,292.66</strong>
                    </td>
                </tr>
            </tbody>
        </table>

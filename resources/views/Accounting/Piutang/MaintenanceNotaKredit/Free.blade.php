                ...
                <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                    <div class="form-container col-md-12">
                        <form method="POST" action="">
                            ...
                            <div class="d-flex">
                                <div class="col-md-2">
                                    <label for="totalPemakaian" style="margin-right: 10px;">Total Free</label>
                                </div>
                                <div class="col-md-3">
                                    <input type="text" id="totalFree" class="form-control"
                                        style="width: 100%">
                                </div>
                            </div>
                            <br>
...
<script src="{{ asset('js/Accounting/Piutang/MaintenanceNotaKredit/Free.js') }}"></script>
@endsection

...
<body>
                ...
                <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse;">
                    ...
                    <tr>
                        <td colspan="3"
                            ...
                            <img src="{{ asset('images/envelope.png') }}" width="13"
    ...
    @php
        ...
        $sumAmount = 0;
        $totalDisc = !empty($dataCetak) ? array_sum(array_map(fn($row) => (float) $row->Disc_trm, $dataCetak)) : 0;
        $chunkSize = 5;
        $chunks = !empty($dataCetak) ? array_chunk($dataCetak, $chunkSize) : [];
    ...
    <div class="box">
        <div style="width: 100%; height: auto; display: flex;">
            <div style="width: 50%; height: auto; margin-right: 20px;">
                <h1 style="font-size: 12px;font-family: Helvetica; font-weight: bold; margin:2px 0 10px 0;">
                    Issued To:
                </h1>
            ...
            <div style="width: 50%; height: auto; margin-left: 20px;">
                ...
                <div style="width: 100%; display: flex;">
                    ...
                    <div style="width: 70%; height: auto;">
                        <div style="font-size: 11px;font-family: Helvetica; margin: 2px 0; display:flex">
                            <span>:</span>
            ...
            <table style="width: 100%; border-collapse: collapse;">
                <thead>
                    <tr>
                        ...
                        @php
                            $totalDisc = array_sum(array_map(fn($row) => (float) $row->Disc_trm, $dataCetak));
                        @endphp
                    ...
                    @if (count($dataCetak) > 1)
                        <div style="width: 100%; display: flex;">
                            ...
                            <div style="width: 60%; border-bottom: 1px solid; text-align: right;">
                                <p
                                    style="line-height: 13.8px; font-size: 13px;font-family: Helvetica; margin: 2px 0;white-space: nowrap;">
                                    {{ $dataCetak[0]->Symbol }}
        ...
        @if ($deliveryTerm)
            <div style="width: 80%; height: auto; margin-left: 20px;">
                <div style="width: 100%; display: flex;">
                    <div style="width: 30%; height: auto;">
                        <h1 style="font-size: 12px;font-family: Helvetica; font-weight: bold; margin: 2px 0;">
                            Delivery Term
                        </h1>
                    </div>

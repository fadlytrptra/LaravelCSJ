                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-end mt-2">
                            <button type="submit" class="btn btn-md btn-primary btn_approve" name="action" value="Approve">
                                Proses
                            </button>
                            <button type="submit" class="btn btn-md btn-warning btn_revisi" name="action" value="Revisi">
                                Revisi
                            </button>
                            {{-- BATAL --}}

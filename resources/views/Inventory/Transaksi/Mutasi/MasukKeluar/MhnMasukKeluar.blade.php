                ...
                <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                    ...
                    <div id="baris-2">
                        <div class="col-sm-8">
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <label for="noPIB">Nomor PIB</label>
                                </div>
                                <div class="col-sm-4">
                            ...
                            <div class="row">
                                <div class="col-sm-2">
                                    <label for="saldoPerPIB">Saldo per PIB</label>
                                </div>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="saldoPrimerPerPIB"
                                        name="saldoPrimerPerPIB" readonly>
                                </div>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="saldoSekunderPerPIB"
                                        name="saldoSekunderPerPIB" readonly>
                                </div>
                                <div class="col-sm-3">
                                    <input type="text" class="form-control" id="saldoTritierPerPIB"
                                        name="saldoTritierPerPIB" readonly>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="baris-3 pl-3">
                        <div class="row pt-2 pb-2">
                            ...
                            <div class="col-sm-5">
                                <label style="color: blue">* contoh Mutasi Keluar, SJ A000123 SAMPLE UNTUK PT.
                                    XYZ</label>
                            </div>
                        </div>

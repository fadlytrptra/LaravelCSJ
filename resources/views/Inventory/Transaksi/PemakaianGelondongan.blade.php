...
@section('title', 'Transaksi Harian')
            ...
            <div class="col-md-10 RDZMobilePaddingLR0">
                <div class="card">
                    ...
                    <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="namaBarang" name="namaBarang"
                                            readonly>
                                        <div class="input-group-append">
                                            <button type="button" id="btn_namabarang" class="btn btn-info" disabled>...</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-1">
                            ...
                            <div class="row mt-1 pr-5">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="objekNama2" name="objekNama2"
                                            readonly>
                                        <div class="input-group-append">
                                            <button type="button" id="btn_objek2" class="btn btn-info" disabled>...</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <div class="input-group-append">
                                            <button type="button" id="btn_kelompok2" class="btn btn-info" disabled>...</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="kelutNama2" name="kelutNama2"
                                            readonly>
                                        <div class="input-group-append">
                                            <button type="button" id="btn_kelut2" class="btn btn-info" disabled>...</button>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-2">
                                ...
                                <div class="col-sm-4">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" id="subkelNama2" name="subkelNama2"
                                            readonly>
                                        <div class="input-group-append">
                                            <button type="button" id="btn_subkel2" class="btn btn-info" disabled>...</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="baris-1 pl-3">
                            <div class="row">
                                <div class="col-sm-1 mt-2 mb-2">
                                    <button type="button" id="btn_hitung" class="btn btn-info" disabled>Hitung Gld</button>
                                </div>

                                <div class="col-sm-2 mt-2 mb-2" style="margin-left: 3%">
                                    <label>Jumlah Mutasi</label>
                                </div>

                                <div class="col-sm-2 mt-2" style="margin-left: -5%">
                                    <div class="input-group">
                                ...
                                <div class="col-sm-1 mt-2" style="margin-left: -2%">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="satuanPrimer2" name="satuanPrimer2"
                                            readonly>
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-2 mt-2" style="margin-left: 3%">
                                    <div class="input-group">
                                        <input type="text" class="form-control" id="triter2" name="triter2"
                                            readonly>
                                    </div>
                                </div>
                                <div class="col-sm-1 mt-2" style="margin-left: -2%">
                        ...
                        <div class="row" id="tableHideShow" style="margin-top: 0.5%">
                            <div class="col-sm-12">
    ...
    <link rel="stylesheet" href="{{ asset('css/Inventory/Transaksi/PemakaianGelondongan.css') }}">
    <script src="{{ asset('js/Inventory/Transaksi/PemakaianGelondongan.js') }}"></script>

    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-10 RDZMobilePaddingLR0">
                ...
                @endif
                <div class="card">
                    <div class="card-header">Edit Expeditor</div>
                    <div class="card-body RDZOverflow RDZMobilePaddingLR0">
                        <div>
                            <form method="POST" action="{{ route('expeditor.update', $model->IDExpeditor) }}" id="">
                                {{ csrf_field() }}
                                            ...
                                            <div class="acs-div-filter">
                                                ...
                                                <div class="acs-div-filter1">
                                                    <input type="text" name="NamaExpeditor" id="NamaExpeditor"
                                                        ...
                                                        value="{{ $model->NamaExpeditor }}" readonly>
                                                        <label style="white-space:
                                                        nowrap" for="KodeExpeditor">Kode Expeditor: </label>
                                                    <input type="text" name="KodeExpeditor" id="KodeExpeditor"
                                                        placeholder="Kode Expeditor" style="width: 28%;" class="input"
                                                        value="{{ $model->IDExpeditor }}" readonly>
                                                </div>
                                            </div>
                                            <div class="acs-div-filter">
                                            ...
                                            <div class="acs-form1">
                                                ...
                                                <div class="acs-div-filter">
                                                    ...
                                                    <input type="text" name="Email" id="Email"
                                                        placeholder="Email" class="input" value="{{ $model->Email }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>

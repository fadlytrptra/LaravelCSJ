jQuery(function ($) {
    ...
    let radio_jenisBKMPenagihan = document.getElementById("radio_jenisBKMPenagihan"); //prettier-ignore
    let radio_jenisCashAdvance = document.getElementById("radio_jenisCashAdvance"); //prettier-ignore
    ...
    function init() {
        radio_jenisBKMPenagihan.checked = true;
            ...
            `,
                ...
                didOpen: () => {
                    $(document).ready(function () {
                        let checkedRadio = document.querySelector('input[name="radio_jenisBKM"]:checked'); // prettier-ignore
                ...
                if (result.isConfirmed) {
                    ...
                    id_bkm.value = result.value.Id_BKM;
    ...
    button_cetak.addEventListener("click", function (e) {
        ...
        let url = `/CetakBKM/printBKM?idbkm=${id_bkm.value}&jenisCetak=${checkedRadio.value}&tanggal=${tanggal_penagihan.value}`;

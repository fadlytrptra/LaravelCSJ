$(document).ready(function () {
    ...
    btn_proses.addEventListener("click", async function (event) {
        ...
        let grandTotal = parseFloat(totalFree.value.replace(/,/g, ""));
    ...
    btn_tambahItem.addEventListener("click", async function (event) {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                var tTotal = totalKirim * hargaSatuan;
                ...
                // totalPot.value = data.total_kirim;
            },
        ...
        document
            ...
            .addEventListener("shown.bs.modal", function () {
                btn_simpanM.focus(); // Fokuskan input
            });
    ...
    btn_simpanM.addEventListener("click", async function (event) {
        ...
        totalFree.value = numeral(totalPotongan).format("0,0.00");
        ...
        try {
            const result = await Swal.fire({
                ...
                if (result.isConfirmed && result.value) {
                    ...
                    $.ajax({
                        url: "Free/displayNotaKreditDetails",
                        type: "GET",
                        data: {
                            _token: csrfToken,
                            no_notaKredit: no_notaKredit.value,
                        ...
                        success: function (data) {
                            ...
                            data.data.forEach(function (item, index) {
                                ...
                                const newRow = {
                                    ...
                                    jumlahKirim: numeral(item.QtyBrg).format('0'),
                                    hargaLama: numeral(item.HargaPot).format('0'),
                                    hargaBaru: numeral(item.HargaSP).format('0'),
                                    id: item.IdDetail,
